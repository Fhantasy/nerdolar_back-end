...
export const locale: Locale = {
  ...
  translations: {
    ...
    labels: {
      ...
      media_products: "Produtos de Mídia",
      comments: "Comentários",
      categories: "Categorias",
      users: "Usuários",
      genres: "Generos",
      posts: "Postagens",
      watch_items: "Items para assistir",
      postImages: "Imagems de Post",
      media_genres: "Generos da mídia",
      likes: "Curtidas",
      follows: "Seguidas",
    },
    properties: {
      ...
      title: "Título",
      isEpisodic: "É episódico",
      launchDate: "Data de estréia",
      endDate: "Data de término",
      uploadImg: "Upload da Imagem",
      message: "Mensagem",
      releaseDates: "Datas de lançamento",
      categoryId: "Categoria",
      mediaProductId: "Produto",
      thumbnailImage: "Imagem miniatura",
      pageBannerImage: "Imagem do banner",
      profileImage: "Imagem de perfil",
      profileBannerImage: "Imagem do banner do perfil",
      userId: "Usuário",
      createdAt: "Criado em",
